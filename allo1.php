 ...
 if($_FILES['file']['name'])
 {
  ...
  if($filename[1] == 'csv')
  {
    ...
    while($data = fgetcsv($handle))
    {
                ...
                $query1 = "INSERT into tab3 (id,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12) values('$item1','$item2','$item3','$item4','$item5','$item6','$item7','$item8','$item9','$item10','$item11','$item12','$item13')";
